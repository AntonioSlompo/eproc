                ...
                <div className="hidden lg:flex flex-col space-y-8 animate-fade-in-left">
                    <div className="space-y-4">
                        <div className="flex items-center gap-3 mb-8">
                            <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-blue-500 to-purple-600 neon-border flex items-center justify-center">
                                <Sparkles className="w-6 h-6 text-white" />
                            </div>
                            <span className="text-3xl font-bold tracking-tight">E-Procurement</span>
                        </div>

                        <h1 className="text-5xl font-bold leading-tight">
                            Bem-vindo de volta ao
                            <span className="block neon-text mt-2">Futuro das Compras</span>
                        </h1>

                        <p className="text-lg text-neutral-400 leading-relaxed max-w-md">
                            Acesse sua plataforma de procurement inteligente e gerencie todas as suas aquisições com eficiência.
                        </p>
                    </div>
                    ...
                    <div className="glass-card p-8 md:p-10 space-y-6">
                        ...
                        <div className="relative">
                            ...
                            <div className="relative flex justify-center text-sm">
                                <span className="px-4 bg-[var(--card-bg)] text-neutral-400">ou continue com email</span>
                            </div>
                        </div>
                            ...
                            <div className="flex items-center justify-between text-sm">
                                <label className="flex items-center gap-2 cursor-pointer group">
                                    <input
                                        ...
                                        className="w-4 h-4 rounded border-white/20 bg-white/5 checked:bg-blue-500 checked:border-blue-500 transition-all cursor-pointer"
                                    />
